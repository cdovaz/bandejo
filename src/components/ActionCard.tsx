...
export default function ActionCard({ headline, queueTime, reportCount }: ActionCardProps) {
  return (
    <div className="flex flex-col justify-between rounded-lg bg-gray-800 p-6 text-center shadow-lg transition-transform duration-300 hover:scale-105 h-full">
      ...
      <Link href={`/report?restaurant=${encodeURIComponent(headline)}`}>
        <Button type="button">
          avaliar situação
        </Button>
      </Link>
